...
const setupQueueCommand = require('./queue');
...
module.exports = (data, iotajs, queue, refreshAccountData, refreshServerInfo, vorpal) => {
  setupValidators(data, vorpal);

  setupAddressCommand(data, iotajs, queue, vorpal);
  ...
  setupQueueCommand(data, queue, vorpal);
